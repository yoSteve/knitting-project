...
import { LopiComponent } from './lopi.component';

describe('LopiComponent', () => {
  let component: LopiComponent;
  let fixture: ComponentFixture<LopiComponent>;

  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ LopiComponent ]
    })
    .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(LopiComponent);
...
// TODO: adapt these tests to work with LopiComponent
